...
import io.akudrin.ppmtool.repositories.ProjectTaskRepository;
...
public class ProjectTaskService {
	...
	public void deletePTByProjectSequence(String backlog_id, String pt_id, String username) {
		ProjectTask projectTask = findPTByProjectSequence(backlog_id, pt_id, username);
		/*
		 * Not a good way to do delete backlogs Backlog backlog =
		 * projectTask.getBacklog(); List<ProjectTask> pts = backlog.getProjectTasks();
		 * pts.remove(projectTask); backlogRepository.save(backlog);
		 */
